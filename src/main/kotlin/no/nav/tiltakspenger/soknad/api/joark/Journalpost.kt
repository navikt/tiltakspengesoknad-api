...
sealed class Journalpost {
    ...
    data class Søknadspost private constructor(
        ...
        companion object {
            ...
            private fun lagHoveddokument(pdf: ByteArray, søknadTilJoarkDTO: SøknadTilJoarkDTO): JournalpostDokument =
                JournalpostDokument(
                    ...
                    dokumentvarianter = listOf(
                        ...
                        DokumentVariant.OriginalJson(
                            fysiskDokument = Base64.getEncoder()
                                .encodeToString(objectMapper.writeValueAsString(søknadTilJoarkDTO).toByteArray()),
                        ),
                    ),
                )
